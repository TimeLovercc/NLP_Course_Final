...
with open(f"./{args.dataset}_results.txt", "a+") as f:
    f.write(f"This is ssl. Validation accuracy: {val_accuracy:.4f}, dataset: {args.dataset}, test_time: {args.test_time}, weight: {args.weight}, lr: {args.lr}, weight_decay: {args.weight_decay}, mask_ratio: {args.mask_ratio}\n")
